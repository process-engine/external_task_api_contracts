namespace ProcessEngine.ExternalTaskAPI.Contracts
{
    ...
    public interface IExternalTaskAPIClient
    {
        ...
        Task FetchAndLockExternalTasks<TPayload>(string identity, string topicName, int maxTasks, int longPollingTimeout, int lockDuration, Action<IEnumerable<ExternalTask<TPayload>>> externalTasksFound);
        ...
        Task ExtendLock(string identity, string externalTaskId, int additionalDuration);
        ...
        Task HandleBpmnError(string identity, string externalTaskId, string errorCode);
        ...
        Task HandleServiceError(string identity, string externalTaskId, string errorMessage, string errorDetails);
        ...
        Task FinishExternalTask<TPayload>(string identity, string externalTaskId, TPayload payload);
    }
}